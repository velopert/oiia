...
- [x] **[2026-04-17] Loop 59 — 세그먼트 랜덤 이동**: 🎰 버튼, 각 세그먼트 길이 유지하고 시작점만 랜덤. 5개 자모 한꺼번에 흔들어서 완전히 다른 oiiai 조합.
- [x] **[2026-04-17] Loop 60 — 100 프레스 셀레브레이션**: 누적 프레스 100 배수마다 5색 `fx.drop()` 체인 (90ms 간격) + 토스트 + 헵틱. "계속 놀게 만드는" 뚫림의 순간.
